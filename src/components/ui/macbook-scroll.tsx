...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[150vh] flex flex-col items-center py-30 md:py-30 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src="/GitHub-GonzaloMB.png"
          alt="GonzaloMB Github"
          fill
...
const AceternityLogo = () => {
  return (
    <img style={{ height: "50px" }} src="/GMB-Logo-Light.png" />
